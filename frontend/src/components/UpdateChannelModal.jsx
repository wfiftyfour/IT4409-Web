...
function UpdateChannelModal({ channel, onClose, onSuccess, onDelete }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm">
      ...
      {/* Modal Card - match CreateChannelModal */}
      <div className="relative w-full max-w-lg rounded-2xl border border-slate-800 bg-white p-0 shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between rounded-t-2xl border-b border-slate-800 px-6 py-4 bg-slate-900">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-2 text-white/80 transition hover:bg-slate-800 hover:text-white"
            aria-label="Close"
          >
            <svg
              className="h-5 w-5"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Anyone in the workspace can join and see this channel.
                  </p>
                </div>
              </label>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Must be approve by a channel admin to join.
                  </p>
                </div>
              </label>
            </div>
